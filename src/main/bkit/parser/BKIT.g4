...
program: var_declarations function_declarations;

var_declarations: (var_declaration)*;

function_declarations: (function_declaration)* main_function_declaration (function_declaration)*;
...
main_function_declaration: FUNCTION COLON 'main' (param_declaration)* function_body;
...
statements: var_declarations (stmt_assignment | stmt_if | stmt_for | stmt_while | stmt_do_while | stmt_break | stmt_continue | stmt_call | stmt_return)*;

stmt_assignment: ID ASSIGN exp SEMI;

stmt_if: IF exp THEN statements (ELSE_IF exp THEN statements)* (ELSE statements)? END_IF DOT;

stmt_for: FOR LP for_iteration RP DO statements END_FOR DOT;

for_iteration: ID ASSIGN exp COMMA exp COMMA exp;
